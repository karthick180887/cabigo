                        ...
                        <div className={styles.mainContent}>
                            ...
                            {pickupAreas.length > 0 && (
                                <div className={styles.contentBlock}>
                                    ...
                                    <p>
                                        We provide pickup and drop taxi services across key taluks
                                        in {district.name}. Choose your pickup point below.
                                    </p>
                                        ...
                                        <tbody>
                                            {districtVehicles.map(v => (
                                                <tr key={v.id}>
                                                    ...
                                                    <td>
                                                        {v.oneWayRatePerKm ? `INR ${v.oneWayRatePerKm}/km` : "Ask for Quote"}
                                                        {v.driverBeta ? (
                                                            <div style={{ fontSize: "0.85rem", color: "var(--color-text-muted)" }}>
                                                                Driver bata INR {v.driverBeta}
                                                            </div>
                                                        ) : null}
                                                    </td>
                                                    <td>{v.capacity}</td>
