...
export const metadata: Metadata = {
    title: "One Way Drop Taxi South India | Pay for Drop Only",
    description: "Save up to 40% with Cabigo One Way Taxi. Pay only for the distance traveled. Available across Tamil Nadu, Kerala, Karnataka, Andhra Pradesh, and Telangana.",
        ...
        <div className="container" style={{ paddingTop: '120px', paddingBottom: '80px' }}>
            ...
            <div className="grid grid-3" style={{ gap: '2rem', marginBottom: '4rem' }}>
                ...
                <div className="card" style={{ borderColor: 'var(--color-pepper)' }}>
                    <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>📍</div>
                    <h3>Anywhere Drop</h3>
                    <p>We cover routes across Tamil Nadu, Karnataka, Kerala, Andhra Pradesh, and Telangana.</p>
                </div>
