...
export const metadata: Metadata = {
    ...
    description: 'Privacy Policy for Cabigo Driver Partner Application',
};

export default function DriverPrivacy() {
    return (
        <main className="container mx-auto px-4 py-12 max-w-4xl">
            <h1 className="text-3xl font-bold mb-6 text-gray-800 border-b pb-4">Privacy Policy for Cabigo Driver Partner App</h1>
