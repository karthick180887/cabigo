...
export const metadata: Metadata = {
    title: "Round Trip Taxi South India | Outstation Cabs @ INR 11/km",
    description: "Book Round Trip cabs for outstation travel from Chennai, Bengaluru, Coimbatore, Kochi, and Hyderabad. Lowest km rates across South India.",
        ...
        <div className="container" style={{ paddingTop: '120px', paddingBottom: '80px' }}>
            ...
            <div className="grid grid-3" style={{ gap: '2rem', marginBottom: '4rem' }}>
                ...
                <div className="card" style={{ borderColor: 'var(--color-pepper)' }}>
                    <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>💰</div>
                    <h3>Best Value</h3>
                    <p>Round trips start at just INR 11/km for Hatchbacks. Cheaper than booking two one-ways.</p>
                </div>
