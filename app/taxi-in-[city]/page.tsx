...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const district = getDistrictBySlug(city);

    if (!district) {
        return generateServiceAreaDistrictMetadata(city);
    }
...
export default async function DetailedDistrictPage({ params }: PageProps) {
    const { city } = await params;
    const district = getDistrictBySlug(city);

    if (!district) {
        return <ServiceAreaDistrictPage slug={city} />;
    }
            ...
            <section className="section">
                <div className="container">
                    <div className={styles.contentGrid}>
                        ...
                        {/* Right Column: Sidebar / Quick Links / Internal Linking */}
